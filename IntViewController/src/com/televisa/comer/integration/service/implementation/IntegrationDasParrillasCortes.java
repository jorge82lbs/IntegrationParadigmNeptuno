 ...
 *
 * File: IntegrationDasParrillasCortes.java
 *
...
import com.televisa.comer.integration.model.daos.ParrillasCortesDao;
...
import com.televisa.comer.integration.service.interfaces.ParrillasProgramasCortesInterface;
 ...
 */
 public class IntegrationDasParrillasCortes implements ParrillasProgramasCortesInterface{
     ...
     public ParrillasCortesResponse invokeParrillasProgramasyCortes(ParrillasCortesInputParameters toParrillasCortes) {
         ...
         String                  lsDate = toParrillasCortes.getDateQuery();
         String                  lsChannelAll = "";
         ...
         boolean                 lbFlagPr2 = true;
         boolean                 lbFlagPr3 = true;       
         ParrillasCortesDao      loPpyCorDao = new ParrillasCortesDao();
         ...
         new UtilFaces().insertBitacoraServiceService(Integer.parseInt(lsIdRequestParrillasReq), 
                                                      ...
                                                      liIndProcess, 
                                                      "Bandera Parrillas Procesadas [" + liFlag + "]",
                                                      0, 
         ...
         if (liFlag > 0) {             
             ...
             //2.- Insertar en EVENTAS.EVETV_PARRILLAS_PROCESADAS
             System.out.println("2.- Insertar en EVENTAS.EVETV_PARRILLAS_PROCESADAS - FLAG = 0");
             lsMessage = "Insercion en Tabla Control Parrillas Procesadas";
             ResponseUpdDao loPrr2 = loPpyCorDao.insertParrillasProcesadasFlagZero(lsDate, 
                                                           lsChannelAll.substring(0,
                                                                                  lsChannelAll.length() - 1)
                                                           );
             if(loPrr2.getLsResponse().equalsIgnoreCase("ERROR")){
                 lsMessage = loPrr2.getLsMessage();
                 lbFlagPr2 = false;
             }
             liIndProcess = new UtilFaces().getIdConfigParameterByName("InsertProcesadas");
             new UtilFaces().insertBitacoraServiceService(Integer.parseInt(lsIdRequestParrillasReq), 
                                                          Integer.parseInt(lsIdServiceReq), 
                                                          liIndProcess, 
                                                          lsMessage,
             ...
             if(lbFlagPr2){
                 //4.- Extraer de Paradigm y enviar a evetv
                 System.out.println("4.- Extraer de Paradigm y enviar a evetv - FLAG = 0");
                try {
                    loParrillasCortes =
                        loPpyCorDao.getParrillasCortesParadigmDbFlagZero(lsDate,
                                                                         lsChannelAll.substring(0,
                                                                                                lsChannelAll.length() -
                                                                                                1));
                    lsMessage = "Extraccion de Informacion para Servicio de Parrillas";
                } catch (SQLException loEx) {
                    lsMessage = loEx.getMessage();
                }
         ...
         if(lbFlagPr2 && lbFlagPr3){
             ...
             Xmlentrada            loXmlentrada = createXmlentrada(loParrillasCortes);
             liIndProcess = new UtilFaces().getIdConfigParameterByName("createXml");
             new UtilFaces().insertBitacoraServiceService(Integer.parseInt(lsIdRequestParrillasReq), 
                                                          Integer.parseInt(lsIdServiceReq), 
                                                          liIndProcess, 
                                                          "Requets XML creado para Parrillas",
                                                          0, 
                                                          Integer.parseInt(lsIdRequestParrillasReq), 
                                                          Integer.parseInt(lsIdUserReq),
                                                          lsIdUserNameReq
             ...
             try {
                 ...
                 new UtilFaces().insertBitacoraServiceService(Integer.parseInt(lsIdRequestParrillasReq), 
                                                              Integer.parseInt(lsIdServiceReq), 
                                                              liIndProcess, 
                                                              "Servicio Neptuno invocado para Parrillas Cortes",
                                                              0, 
                                                              Integer.parseInt(lsIdRequestParrillasReq), 
                                                              Integer.parseInt(lsIdUserReq),
                                                              lsIdUserNameReq
                 ...
                 try{
                     /*
                     StreamResult result =
                     new StreamResult(new File("C:\\Users\\JorgeOWM\\Desktop\\ParrillasXml"+getId()+".xml"));
                 ...
                 new UtilFaces().insertBitacoraServiceService(Integer.parseInt(lsIdRequestParrillasReq), 
                                                              Integer.parseInt(lsIdServiceReq), 
                                                              liIndProcess, 
                                                              "Respuesta de Neptuno Obtenida para Parrillas Cortes",
                                                              0, 
                                                              Integer.parseInt(lsIdRequestParrillasReq), 
                                                              Integer.parseInt(lsIdUserReq),
                                                              lsIdUserNameReq
                 ...
                 ParrillasCortesDao                 loDao = new ParrillasCortesDao();
                         ...
                         if(lsElemento != null && lsElemento.equalsIgnoreCase("Break")) {
                             ...
                             if (liFlag > 0) {                                 
                                 if(lsRess.equals("KO")){
                                     ...
                                     EvetvParrillasProcesadasBean loBean = new EvetvParrillasProcesadasBean();
                                     loBean.setLsStnid(lsCanal);
                                     loBean.setLsBcstdt(lsDateBreak);
                                     loBean.setLsPgmid(lsDescription);
                                     loBean.setLsBrkdtid(lsBreak);
                                     laEppBeans.add(loBean);                                     
                                     loDao.updateEveTvParrillas(lsIdRequestParrillasReq,
                                                                lsIdServiceReq,
                                                                "T",
                                                                lsIdUserNameReq,
                                 ...
                                 if(lsDateBreak != null){
                                     loPpyCorDao.updateStstusParrillasProcesadas(lsCanal, 
                                                                                buildDatePardigm(lsDateBreak, "dd/MM/YYYY"), 
                                                                                lsDescription, 
                                                                                lsBreak,
                                                                                lsRess.equals("KO") ? "2" : "0"
                                                                                );  
                                 }else{
                                     loPpyCorDao.updateStstusParrillasProcesadas(lsCanal, 
                                                                                 null, 
                 ...
                 if (liFlag > 0) {
                     ...
                     /*
                     //6.- Actualizar PGMTXRNTEL
                     System.out.println("6.- Actualizar PGMTXRNTEL");
                     ResponseUpdDao loResTxr = loPpyCorDao.updateFlagsPgmtxrntei();
                     lsMessage = "Actualizacion de tabla PGMTXRNTEL para Parrillas Cortes";
                     if(loResTxr.getLsResponse().equalsIgnoreCase("OK")){
                         lsMessage = "Actualizacion[" + loResTxr.getLiAffected() + "] de tabla PGMTXRNTEL para " +
                             "Parrillas Cortes";
                     }else{
                         lsMessage = loResTxr.getLsMessage();   
                     }
                     
                     liIndProcess = new UtilFaces().getIdConfigParameterByName("UpdatePGMTXRNTEL");
                     new UtilFaces().insertBitacoraServiceService(Integer.parseInt(lsIdRequestParrillasReq), 
                                                                  Integer.parseInt(lsIdServiceReq), 
                                                                  liIndProcess, 
                                                                  lsMessage,
                     ...
                     //7.- Actualizar A_BRKDTTEL
                     System.out.println("7.- Actualizar A_BRKDTTEL");
                     ResponseUpdDao loResBrk = loPpyCorDao.updateFlagsABrkdttel();
                     lsMessage = "Actualizacion de tabla A_BRKDTTEL para Parrillas Cortes";
                     if(loResBrk.getLsResponse().equalsIgnoreCase("OK")){
                         lsMessage = "Actualizacion[" + loResBrk.getLiAffected() + "] de tabla A_BRKDTTEL para " +
                             "Parrillas Cortes";
                     }else{
                         lsMessage = loResBrk.getLsMessage();   
                     }
                     liIndProcess = new UtilFaces().getIdConfigParameterByName("UpdateA_BRKDTTEL");
                     new UtilFaces().insertBitacoraServiceService(Integer.parseInt(lsIdRequestParrillasReq), 
                                                                  Integer.parseInt(lsIdServiceReq), 
                                                                  liIndProcess, 
                                                                  lsMessage,
                    ...
                    //8.- Actualizar a CERO cuando evetv haya dado respusta OK
                     System.out.println("8.- Actualizar a CERO cuando evetv haya dado respusta OK");
                     for(EvetvParrillasProcesadasBean loBean :laEppBeans){
                         //System.out.println("Actualizando a 0: CANAL["+loBean.getLsStnid()+"] FECHA["+buildDatePardigm(loBean.getLsBcstdt(), "dd/MM/YYYY")+"] DESC["+loBean.getLsPgmid()+"] Brkdtid["+loBean.getLsBrkdtid()+"] ");
                         loPpyCorDao.updateStstusParrillasProcesadas(loBean.getLsStnid(), 
                                                                     buildDatePardigm(loBean.getLsBcstdt(), 
                                                                                     "dd/MM/YYYY"), 
                                                                     loBean.getLsPgmid(), 
                                                                     loBean.getLsBrkdtid(), 
                                                                     "0"
                     ...
                     new UtilFaces().insertBitacoraServiceService(Integer.parseInt(lsIdRequestParrillasReq), 
                                                                  Integer.parseInt(lsIdServiceReq), 
                                                                  liIndProcess, 
                                                                  "Actualizacion de Status en Tablas de Control para " +
                                                                  "Parrillas Cortes",
                                                                  0, 
                                                                  Integer.parseInt(lsIdRequestParrillasReq), 
                                                                  Integer.parseInt(lsIdUserReq),
      ...
      * @return Xmlentrada
      */
     private Xmlentrada createXmlentrada(List<RsstParrillasCortesBean> toParrillasCortes) {
