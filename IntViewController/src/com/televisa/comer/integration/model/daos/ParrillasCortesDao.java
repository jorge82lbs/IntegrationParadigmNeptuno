...
import com.televisa.comer.integration.model.interfaces.ParrillasCortesInterface;
 ...
 */
public class ParrillasCortesDao implements ParrillasCortesInterface {
     ...
     */
    @Override
    public String getQueryParadigm(String tsDate, String tsChannels) {
        // Escenario 2 (flag>0) no existe parametro de CANALES
        String lsQuery = 
            "SELECT\n" + 
            "    LOGEDT.BCSTTIM,\n" + 
            "    LOGEDT.SEQNUM,\n" + 
            ...
            "    CASE SUBSTR(CHAR(PARADB.PGMSCH.SCHTIM),1,2) WHEN '24' THEN '24' WHEN '25' THEN '01' WHEN '26' THEN '26'\n" + 
            ...
            "        (SELECT X.STNID, X.BCSTDT, X.PGMID, X.SCHTIM\n" + 
            "                FROM EVENTAS.EVETV_PARRILLAS_PROCESADAS X\n" + 
            "                WHERE X.STATUS = 1\n" + 
            "                GROUP BY X.STNID, X.BCSTDT, X.PGMID, X.SCHTIM) Z\n" + 
            ...
            "AND PARADB.PGMSCH.SCHTIM = Z.SCHTIM\n" + 
            ...
            "AND LOGEDT.PGMID = Z.PGMID\n" + 
            "AND LOGEDT.BCSTTIM between Z.SCHTIM and (select j.etim\n" + 
            "                                        from PARADB.pgmsch j\n" + 
            "                                        where j.schtim = z.schtim\n" + 
            "                                        and j.stnid = z.stnid\n" + 
            "                                        and j.schdt = z.bcstdt\n" + 
            "                                        and j.pgmid = z.pgmid\n" + 
            "                                        group by j.etim)\n" + 
...
/*CH*/        "    WHEN 3 THEN '00:00:0'||SUBSTR(CHAR(LOGEDT.NOMLEN),1,1)\n" +             
            "    WHEN 7 THEN '0'||SUBSTR(CHAR(LOGEDT.NOMLEN),1,1)||':'||\n" + 
            "    SUBSTR(CHAR(LOGEDT.NOMLEN),2,2)||':'||SUBSTR(CHAR(LOGEDT.NOMLEN),4,2)\n" + 
            "    WHEN 8 THEN CASE SUBSTR(CHAR(LOGEDT.NOMLEN),1,2) WHEN '24' THEN '00' WHEN '25' THEN '01' WHEN '26' THEN '26'\n" + 
            "    WHEN '27' THEN '27' WHEN '28' THEN '28' WHEN '29' THEN '29' ELSE SUBSTR(CHAR(LOGEDT.NOMLEN),1,2)\n" + 
...
/*CH*/        "    WHEN 3 THEN '00:00:0'||SUBSTR(CHAR(LOGEDT.NOMLEN),1,1)\n" +                         
        ...
        //System.out.println("******* Parrillas FLAG > 0 ****************");
     ...
     */
    @Override
    public List<RsstParrillasCortesBean> getParrillasCortesParadigmDb(String tsDate, 
                                                                      String tsChannels
                                                                      ) throws SQLException {
        ...
        String                        lsQueryParadigm = 
            getQueryParadigm(tsDate, tsChannels);
        int liCounter = 0;
        try {
...
/*CH*/      "AND LOGEDT.BCSTDT >= '2018-01-01'\n" + 
    ...
    public ResponseUpdDao callParrillasOnDemandPr(String tsStnid, 
        ...
        System.out.println("tsStnid["+tsStrdt+"]");
        System.out.println("tsStnid["+tsEdt+"]");
        System.out.println("tsStnid["+tsBuyunitid+"]");
        ResponseUpdDao loResponseUpdDao = new ResponseUpdDao();
        Connection        loCnn = new ConnectionAs400().getConnection();
        CallableStatement loCallStmt = null;
        String            lsQueryParadigm = "call EVENTAS.EVETV_PARRILLAS(?,?,?,?)";
        try {
            ...
            if(tsEdt != null){
                ...
                loResponseUpdDao.setLsMessage("fr");
            }else{
    ...
    public List<RsstParrillasCortesBean> getParrillasOnDemandParadigmDb(String tsChannels,
        ...
        try {
            ...
            System.out.println("Query ejecutado ok............");
