...
// ---    Sat Oct 28 19:54:32 CDT 2017
// ---    Custom code may be added to this class.
// ---    Warning: Do not modify method signatures of generated methods.
// ---------------------------------------------------------------------
public class EvetvIntServiceBitacoraTabViewRowImpl extends ViewRowImpl {
    public static final int ENTITY_EVETVINTSERVICEBITACORATAB = 0;
    ...
    public static final int IDBITACORA = AttributesEnum.IdBitacora.index();
    ...
    public static final int INDEVENTO = AttributesEnum.IndEvento.index();
     ...
     */
    public EvetvIntServiceBitacoraTabViewRowImpl() {
    }

    /**
     * Gets EvetvIntServiceBitacoraTab entity object.
     * @return the EvetvIntServiceBitacoraTab
     */
    public EntityImpl getEvetvIntServiceBitacoraTab() {
        return (EntityImpl) getEntity(ENTITY_EVETVINTSERVICEBITACORATAB);
    }
    ...
    public String getIdBitacora() {
        return (String) getAttributeInternal(IDBITACORA);
    }

    /**
     * Sets <code>value</code> as attribute value for ID_BITACORA using the alias name IdBitacora.
     * @param value value to set the ID_BITACORA
     */
    public void setIdBitacora(String value) {
    ...
    /**
     * Gets the attribute value for IND_EVENTO using the alias name IndEvento.
     * @return the IND_EVENTO
     */
    public String getIndEvento() {
        return (String) getAttributeInternal(INDEVENTO);
    }

    /**
     * Sets <code>value</code> as attribute value for IND_EVENTO using the alias name IndEvento.
     * @param value value to set the IND_EVENTO
     */
    public void setIndEvento(String value) {
        setAttributeInternal(INDEVENTO, value);
    }
