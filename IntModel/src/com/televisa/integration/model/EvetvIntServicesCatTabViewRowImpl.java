...
import com.televisa.integration.model.classic.CnnSourceImpl;
...
// ---------------------------------------------------------------------
public class EvetvIntServicesCatTabViewRowImpl extends ViewRowImpl {
    public static final int ENTITY_EVETVINTSERVICESCATTAB = 0;
     ...
     */
    public EvetvIntServicesCatTabViewRowImpl() {
    }

    /**
     * Gets EvetvIntServicesCatTab entity object.
     * @return the EvetvIntServicesCatTab
     */
    public EntityImpl getEvetvIntServicesCatTab() {
        return (EntityImpl) getEntity(ENTITY_EVETVINTSERVICESCATTAB);
    }
    ...
    public String getAttribute1() {
        ...
        CnnSourceImpl loCnnSourceImpl = new CnnSourceImpl();
        String lsRes = loCnnSourceImpl.getStatusCronByIdService(getIdService()) == null ? 
            "0" : loCnnSourceImpl.getStatusCronByIdService(getIdService());
        if(lsRes.equalsIgnoreCase("2")){
            return "true";
        }else{
            if(lsRes.equalsIgnoreCase("4")){
                return "true";
            }else{
                return "false";
            }
    ...
    public String getAttribute2() {
        ...
        String lsRes = loCnnSourceImpl.getStatusCronByIdService(getIdService()) == null ? 
            "0" : loCnnSourceImpl.getStatusCronByIdService(getIdService());
        if(lsRes.equalsIgnoreCase("2")){
            return "flag_green.gif";
        }else{
            if(lsRes.equalsIgnoreCase("4")){
                return "flag_white.gif";
            }else{
    ...
    public String getAttribute3() {
        ...
        String lsRes = loCnnSourceImpl.getStatusCronByIdService(getIdService()) == null ? 
            "0" : loCnnSourceImpl.getStatusCronByIdService(getIdService());
        if(lsRes.equalsIgnoreCase("2")){
            return "Cron Activo y en Ejecucion";
        }else{
            if(lsRes.equalsIgnoreCase("4")){
                return "Cron Deshabilitado por reinicio de Aplicacion/Servidor";
            }else{
                return "No Apica";
            }
        }      
