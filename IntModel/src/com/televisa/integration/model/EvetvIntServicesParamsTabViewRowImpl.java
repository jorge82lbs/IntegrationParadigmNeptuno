...
// ---------------------------------------------------------------------
public class EvetvIntServicesParamsTabViewRowImpl extends ViewRowImpl {
    public static final int ENTITY_EVETVINTSERVICESPARAMSTAB = 0;
     ...
     */
    public EvetvIntServicesParamsTabViewRowImpl() {
    }

    /**
     * Gets EvetvIntServicesParamsTab entity object.
     * @return the EvetvIntServicesParamsTab
     */
    public EntityImpl getEvetvIntServicesParamsTab() {
        return (EntityImpl) getEntity(ENTITY_EVETVINTSERVICESPARAMSTAB);
    }
